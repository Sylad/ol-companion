/**
 * Hardcoded coordinates of the 18 Ligue 1 clubs for the 2026-2027 season.
 *
...
/** Coords saison 2026-2027 — 18 clubs, ordre alphabétique pour la maintenance.
 * MàJ 2026-08-23 : Nantes + Metz relégués, remplacés par Le Mans + Troyes
 * (id365 depuis /api/standings live, idFootballData depuis
 * /v4/competitions/2015/teams, coords stades depuis Nominatim/OSM).
...
export const LIGUE1_CLUBS_COORDS: Ligue1Club[] = [
  ...
  { id365: 468, idFootballData: 535, name: 'Le Mans', city: 'Le Mans', stadium: 'Stade Marie-Marvingt', lat: 47.9592, lng: 0.2231 },
  ...
  { id365: 488, idFootballData: 531, name: 'Troyes', city: 'Troyes', stadium: "Stade de l'Aube", lat: 48.3075, lng: 4.0985 },
];
